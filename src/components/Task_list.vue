...
<template>
  <div class="tasks_list">
    <div class="btns">
      <div class="btn" @click="addTask">+</div>
    </div>
    <div class="list">
      <div
        class="column"
      ...
      >
        ...
        <div class="tasks">
          <div
            ...
            @dblclick="editTask(task.task_id)"
          >
            ...
            <div class="column_btns">
              <div class="exit btn" @click="deleteTask(task.task_id)">+</div>
              <div
                class="arrow btn"
              ...
              >
                ...
                >
                  <path
                    d="M0 4H24.5M24.5 4L19 1M24.5 4L19 7"
                    stroke="#BD1212"
                    stroke-opacity="0.47"
                    stroke-width="2"
                  />
